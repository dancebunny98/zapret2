...
For pfSense installation and startup, use: [pfSense setup](pfsense.md).
...
Practical setup for both modes and blockcheck2-to-runtime integration is described here: [OpenBSD setup](openbsd.md).
